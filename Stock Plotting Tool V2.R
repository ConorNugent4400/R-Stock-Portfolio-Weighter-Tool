...
#i.e. it is there for comparison purposes, not allowing it to be part of portfolio
#To See what you need to change ctrl-f : "ThisGuy"
...
#constant column
#Simple terms, you move it it's a pain in the hole later on
...
# Test for each stock
#Not too important but cool to see for testing purposes
...
#ThisGuy
#Add in otehr tickers or replace these with what you want, just do comma then
#ticker in Quotes
